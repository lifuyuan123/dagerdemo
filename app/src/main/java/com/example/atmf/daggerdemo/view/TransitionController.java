    ...
    public final void show(final Activity activity, final Intent intent, final int mBgColor){
        ...
        next_view.post(new Runnable() {
            ...
            public void run() {
                ...
                Bitmap cacheBitmap =getCacheBitmapFromView(next_view);
                ...
                params.setMargins(mRect.left, mRect.top - getActionBarHeight(activity) -getStatusBarHeight(activity), mRect.right, mRect.bottom);
